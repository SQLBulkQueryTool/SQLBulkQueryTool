...
//		} 
	...
	public void assertUpdateCount(int expected) {
		if (expected != updateCount) {
			throw new FrameworkRuntimeException(FrameworkPlugin.Util.getString("AbstractQueryTest.updateCountNotCorrect", expected, updateCount));
		}
	}
	...
	public void assertRowCount(int expected) {
		...
		if (expected != count) {
			throw new FrameworkRuntimeException(FrameworkPlugin.Util.getString("AbstractQueryTest.rowCountNotCorrect", expected, count));
		}
	}
