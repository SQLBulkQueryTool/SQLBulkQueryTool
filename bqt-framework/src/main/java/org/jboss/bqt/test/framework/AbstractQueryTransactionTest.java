...
import org.jboss.bqt.test.framework.connection.ConnectionStrategyFactory;
 ...
 * 
 * <br>
 * The following methods are useful when writing validation logic because they
 * provide a direct connection to the datasource that was used by the VDB. This
 * enables data validation of expected behavior of Teiid. <li>
 * {@link #getSource(String)}.</li> <li>{@link #getXASource(String)}</li>
 * 
 * <br>
 * 
 */
public abstract class AbstractQueryTransactionTest extends
		org.jboss.bqt.test.framework.AbstractQueryTest implements TransactionQueryTestCase {
