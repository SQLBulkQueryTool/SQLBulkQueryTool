...
public class SAXBuilderHelper {
	...
	/**
	 * Returns a SAXBuilder using the Parser class defined by the
	 * metamatrix.xmlparser.class System property. If the System property does
	 * not exist, returns a SAXBuilder using the
