 ...
 * {@link #printThrowable(Throwable, PrintStream)} method in order to call
...
public class TestResultSetUtil {
	 ...
	 * @since 4.3
	 */
	// public static List writeAndCompareUpdateCount(int updateCount, File
	// resultsFile, File expectedResultsFile, boolean printToConsole) throws
	// IOException {
	 ...
	 * @since 4.3
	 */
	// public static List writeAndCompareUpdateCount(int updateCount,
	// OutputStream resultsOutput, BufferedReader expectedResultsInput,
	 ...
	 * @since 4.3
	 */
	// public static List writeAndCompareBatchedUpdateCounts(int[] counts,
	// OutputStream resultsOutput, BufferedReader expectedResultsInput,
	// PrintStream defaultPrintStream) {
	// PrintStream out = getPrintStream(resultsOutput, expectedResultsInput,
	// defaultPrintStream);
	...
	// public static List writeAndCompareThrowable(Throwable t, File
	// resultsFile, File expectedResultsFile, boolean printToConsole) throws
	...
	// FileReader(expectedResultsFile));
	// }
	// return writeAndCompareThrowable(t, resultsOutputStream,
	// expectedResultsReader, printToConsole ? System.out : null);
	// }

	// public static List writeAndCompareThrowable(Throwable t, OutputStream
	// resultsOutput, BufferedReader expectedResultsInput, PrintStream
	// defaultPrintStream) throws SQLException {
	// PrintStream out = getPrintStream(resultsOutput, expectedResultsInput,
	// defaultPrintStream);
