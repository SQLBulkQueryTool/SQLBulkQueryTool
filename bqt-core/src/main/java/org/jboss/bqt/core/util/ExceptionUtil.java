...
public class ExceptionUtil {
	 ...
	 * Iterator over any nested exceptions in that Throwable. Currently, only
	 * instances of MetaMatrixException and MetaMatrixRuntimeException are
	 * capable of nesting Throwables - calling this method in that case is
	 * equivalent to calling {@link FrameworkException#getChildren
	 * MetaMatrixException.getChildren()} or
	 * {@link TeiidRuntimeException#getChildren
	 * MetaMatrixRuntimeException.getChildren()}. Otherwise, a non-null "empty"
	 * Iterator is returned, one that simply has no Objects in it.
	 * 
	 * @param e
	 *            any Throwable
...
//		return getLinkedMessages(exception, 0);
	...
	/**
	 * <p>
	 * An Iterator over any nested children <code>Throwable</code>s of either a
	 * MetaMatrixException or a MetaMatrixRuntimeException. The first Object
	 * returned (if any) by <code>next()</code> will be the same
	 * <code>Throwable</code> as returned by the {@link #getChild} method of the
	 * root
	 * </p>
	 * 
	 * <p>
	 * In general, each Object A returned by the <code>next()</code> method is
	 * guaranteed to be an instance of <code>Throwable</code>; the
	 * <i>previous</i> Object B will have been a
	 * <code>MetaMatrixException</code> or
	 * <code>MetaMatrixRuntimeException</code> whose {@link #getChild} method
	 * will return the same Object A.
	 * </p>
	 */
