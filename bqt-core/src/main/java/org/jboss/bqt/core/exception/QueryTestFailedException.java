...
public class QueryTestFailedException extends Exception implements Serializable {
	 ...
	 * is a MetaMatrixException or a {@link TeiidRuntimeException}, then the
	 ...
	 * key. Otherwise, if the specified exception is a MetaMatrixException or a
	 * {@link TeiidRuntimeException}, the code will be set to the exception's
	 * code.
	 * 
	 * @param e
