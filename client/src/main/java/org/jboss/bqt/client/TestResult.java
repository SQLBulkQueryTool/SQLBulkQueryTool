 ...
 * include 1 or more sql commands that are considered 1 inclusive test.
 * 
 * @author vanhalbert
 * 
 */
public interface TestResult {
	...
	public interface RESULT_STATE {
		 ...
		 * exceeded the threshold specified {@link TestProperties#PROP_EXECUTE_EXCEED_PERCENT}
		 */
...
/**
    ...
    */
	...
	/**
	 * Set the exception that indicates the reason why there is a problem with
	 * the results. Call {@link #setExceptionMessage(String)} to display a
	 * different message in the summary file.
	 * 
	 * @param error
	 */
	...
	/**
	 * Set the error message relating to the reason why there is a problem with
	 * the results.
	 * 
	 * @param errorMsg
	 */
