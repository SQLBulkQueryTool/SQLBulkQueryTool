...
/**
 * This class contains a set of static utility methods for checking method
 * arguments. It contains many of the common checks that are done, such as
 * checking that an Object is non-null, checking the range of a value, etc. All
 * of these methods throw {@link IllegalArgumentException}.
 */
public class ArgCheck {
	 ...
	 * @param valuea value to be compared to valueb
	 * @param valueb value to be compare to valuea
	 * @param message 
	 * @throws IllegalArgumentException
	 *             If value is negative (<0)
	 */
	public static final void equals(int valuea, int valueb, String message) {
		if (valuea != valueb) {
				throw new IllegalArgumentException(message);
		}
	...
	public static final void isNonNegative(int value, String message) {
		if (value < 0) {
			final String msg = message != null ? message : CorePlugin.Util
					.getString("ArgCheck.isNonNegativeInt"); //$NON-NLS-1$
	...
	public static final void isNonPositive(int value, String message) {
		if (value > 0) {
			final String msg = message != null ? message : CorePlugin.Util
					.getString("ArgCheck.isNonPositiveInt"); //$NON-NLS-1$
			throw new IllegalArgumentException(msg);
		}
	}
	...
	public static final void isNegative(int value, String message) {
		if (value >= 0) {
			final String msg = message != null ? message : CorePlugin.Util
					.getString("ArgCheck.isNegativeInt"); //$NON-NLS-1$
			throw new IllegalArgumentException(msg);
		}
	}
	...
	public static final void isPositive(int value, String message) {
		if (value <= 0) {
			final String msg = message != null ? message : CorePlugin.Util
					.getString("ArgCheck.isPositiveInt"); //$NON-NLS-1$
			throw new IllegalArgumentException(msg);
		}
	}
	...
	public static final void isNotZeroLength(String value, String message) {
		...
		if (value.length() <= 0) {
			final String msg = message != null ? message : CorePlugin.Util
					.getString("ArgCheck.isStringNonZeroLength"); //$NON-NLS-1$
			throw new IllegalArgumentException(msg);
		}
	}
	...
	public static final void isNotNull(Object value, String message) {
		if (value == null) {
			final String msg = message != null ? message : CorePlugin.Util
					.getString("ArgCheck.isNonNull"); //$NON-NLS-1$
			throw new IllegalArgumentException(msg);
		}
	}
	...
	public static final void isNull(Object value, String message) {
		if (value != null) {
			final String msg = message != null ? message : CorePlugin.Util
					.getString("ArgCheck.isNull"); //$NON-NLS-1$
			throw new IllegalArgumentException(msg);
		}
	}
	...
	public static final void isInstanceOf(Class theClass, Object value,
		...
		if (!theClass.isInstance(value)) {
			final String msg = message != null ? message
					: CorePlugin.Util
							.getString(
									"ArgCheck.isInstanceOf", theClass.getName(), value.getClass().getName()); //$NON-NLS-1$
			throw new IllegalArgumentException(msg);
		}
	}
	...
	public static final void isNotEmpty(Collection collection, String message) {
		...
		if (collection.isEmpty()) {
			final String msg = message != null ? message : CorePlugin.Util
					.getString("ArgCheck.isCollectionNotEmpty"); //$NON-NLS-1$
			throw new IllegalArgumentException(msg);
		}
	}
	...
	public static final void isNotEmpty(Map map, String message) {
		...
		if (map.isEmpty()) {
			final String msg = message != null ? message : CorePlugin.Util
					.getString("ArgCheck.isMapNotEmpty"); //$NON-NLS-1$
			throw new IllegalArgumentException(msg);
		}
	}
	...
	public static final void isNotEmpty(Object[] array, String message) {
		...
		if (array.length == 0) {
			final String msg = message != null ? message : CorePlugin.Util
					.getString("ArgCheck.isArrayNotEmpty"); //$NON-NLS-1$
			throw new IllegalArgumentException(msg);
		}
	}
	...
	/**
	 * Asserts that the specified first object is not the same as (==) the
	 * specified second object.
	 * 
	 * @param firstObject
	 *            The first object to assert as not the same as the second
	 *            object.
	 * @param firstName
	 *            The name that will be used within the exception message for
	 *            the first object, should an exception be thrown; if null and
	 *            <code>firstObject</code> is not null,
	 *            <code>firstObject.toString()</code> will be used.
	 * @param secondObject
	 *            The second object to assert as not the same as the first
	 *            object.
	 * @param secondName
	 *            The name that will be used within the exception message for
	 *            the second object, should an exception be thrown; if null and
	 *            <code>secondObject</code> is not null,
	 *            <code>secondObject.toString()</code> will be used.
	 * @throws IllegalArgumentException
	 *             If the specified objects are the same.
	 * @since 3.1
	 */
	public static void isNotSame(final Object firstObject, String firstName,
			final Object secondObject, String secondName) {
		if (firstObject == secondObject) {
			...
			throw new IllegalArgumentException(CorePlugin.Util.getString(
					"ArgCheck.isNotSame", firstName, secondName)); //$NON-NLS-1$
		}
	}
	...
	public static final void contains(Collection collection, Object value,
		...
		if (!collection.contains(value)) {
			final String msg = message != null ? message : CorePlugin.Util
					.getString("ArgCheck.contains"); //$NON-NLS-1$
			throw new IllegalArgumentException(msg);
		}
	}
	...
	public static final void containsKey(Map map, Object key, String message) {
		...
		if (!map.containsKey(key)) {
			final String msg = message != null ? message : CorePlugin.Util
					.getString("ArgCheck.containsKey"); //$NON-NLS-1$
			throw new IllegalArgumentException(msg);
		}
	}
