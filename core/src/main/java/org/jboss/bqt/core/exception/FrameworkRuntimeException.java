 ...
 * class can be used to maintain a linked list of exceptions.
 * <p>
 * 
...
public class FrameworkRuntimeException extends RuntimeException {
	...
	public static final String CAUSED_BY_STRING = CorePlugin.Util
			.getString("RuntimeException.Caused_by"); //$NON-NLS-1$
	 ...
	 */
	public FrameworkRuntimeException(final String message) {
		super(message);
	}
	 ...
	 *            The error message or a resource bundle key
	 */
	public FrameworkRuntimeException(final int code, final String message) {
		super(message);
	...
	public FrameworkRuntimeException(final String code, final String message) {
		super(message);
		// The following setCode call should be executed after setting the
		// message
		setCode(code);
	...
	/**
	 * Construct an instance with a linked exception specified. If the exception
	 * is a {@link FrameworkException} or a MetaMatrixRuntimeException, then the
	 * code will be set to the exception's code.
	 * 
	 * @param e
	 *            An exception to chain to this exception
	 */
	public FrameworkRuntimeException(final Throwable e) {
		this(
				e,
				(e instanceof java.lang.reflect.InvocationTargetException) ? ((java.lang.reflect.InvocationTargetException) e)
						.getTargetException().getMessage() : (e == null ? null
						: e.getMessage()));
	}
	 ...
	 * key. Otherwise, if the specified exception is a
	 * {@link FrameworkException} or a MetaMatrixRuntimeException, the code will
	 ...
	 *            The error message or a resource bundle key
	 */
	public FrameworkRuntimeException(final Throwable e, final String message) {
		super(message, e);
		setCode(e);
	}
	 ...
	 *            The error message or a resource bundle key
	 */
	public FrameworkRuntimeException(final Throwable e, final int code,
	...
	/**
	 * Construct an instance with the linked exception, error code, and error
	 * message specified. If the specified exception is a
	 * {@link FrameworkException} or a MetaMatrixRuntimeException, the code will
	 * be set to the exception's code.
	 * 
	 * @param e
	 ...
	 *            The error message
	 */
	public FrameworkRuntimeException(final Throwable e, final String code,
			final String message) {
		super(message, e);
