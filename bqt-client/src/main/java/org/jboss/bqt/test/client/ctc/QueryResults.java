 ...
 * 02110-1301 USA.
 */
package org.jboss.bqt.test.client.ctc;
...
public class QueryResults implements Externalizable {
	...
	/**
	 * Construct a QueryResults from a TupleBatch. Take all rows from the
	 * QueryBatch and put them into the QueryResults.
	 * 
	 * @param elements
...
//	}
	 ...
	 * <p>
	 * The value returned is not mutable -- changes made to this value will not
	 * affect the QueryResults object.
	 * <p>
	 * <b>Note that results must be retrieved with the same type of data node
	 * identifier that was specified in the select statement. </b>
	 * <p>
	 * 
	 * @param columnName
	 ...
	 */
//	public Object getValue(String columnName, int recordNumber)
//			throws IllegalArgumentException, IndexOutOfBoundsException {
//
//		// This throws an IllegalArgumentException if field not in result set
//		int columnNumber = getIndexOfField(columnName);
//
//		return (records != null) ? ((List) records.get(recordNumber))
//				.get(columnNumber) : null;
//	}
...
//	}
	 ...
	 * <p>
	 * The specified field and record must already exist in the data set, or an
	 * exception will be thrown. The {@link #addField(ColumnInfo)}method can be
	 * used to append values or new records for fields.
	 * 
	 * @param field
	 *            The unique data element identifier for the field
	 * @param recordNumber
	 ...
	 */
//	public void setValue(String field, int recordNumber, Object value)
//			throws IllegalArgumentException, IndexOutOfBoundsException {
//
...
//	}
	...
	/**
	 * Returns the index of the specified field is in the result set. An
	 * exception is thrown if the field is not in the set.
	 * 
	 * @param field
	 *            Unique identifier for a data element specified in result set
...
//	}
	...
	// DataTypeManager.getDataTypeName(element.getType()), element.getType(),
	// groupID,
	// element.getMetadataID()));
	// } else { // ExpressionSymbol or AggregateSymbol
	// // Expressions don't map to a single element or group, so don't save that
	// info
	// infos.add(new ColumnInfo(name,
