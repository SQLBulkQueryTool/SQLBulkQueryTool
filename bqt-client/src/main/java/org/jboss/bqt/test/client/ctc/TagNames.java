...
public final class TagNames {
	...
	private static final String DATA_ELE_TYPE_NULL = "null"; //$NON-NLS-1$

	public static Map<String, Class<?>> TYPE_MAP;
	...
	static {
		...
		TYPE_MAP.put(DATA_ELE_TYPE_NULL, java.lang.String.class);
	}
	...
	public static final class Attributes {
		...
		public static final String EXECUTE_NUM_TIMES = "numtimes"; //$NON-NLS-1$
