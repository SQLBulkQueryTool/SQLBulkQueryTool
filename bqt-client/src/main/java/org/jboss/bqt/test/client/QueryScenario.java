...
import org.jboss.bqt.test.client.TestProperties.RESULT_MODES;
...
//		// required property
//		
//		resultModeStr = resultModeStr.trim();


		if (resultModeStr.equalsIgnoreCase(TestProperties.RESULT_MODES.COMPARE)) {
			this.compare = true;
		} else if (resultModeStr.equalsIgnoreCase(TestProperties.RESULT_MODES.GENERATE)) {
			this.generate = true;
		} else if (resultModeStr.equalsIgnoreCase(TestProperties.RESULT_MODES.SQL)) {
			this.sql = true;
		} else if (resultModeStr.equalsIgnoreCase(TestProperties.RESULT_MODES.NONE)) {
			this.none = true;
		} else {
			throw new FrameworkRuntimeException(
