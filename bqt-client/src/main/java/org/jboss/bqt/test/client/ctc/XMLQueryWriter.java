...
import org.jboss.bqt.test.client.QuerySQL;
import org.jboss.bqt.test.client.QueryTest;
import org.jboss.bqt.test.client.QueryWriter;
...
public class XMLQueryWriter implements QueryWriter {
	...
	private void init() throws Exception {
		...
		TestLogger.log("Writing queries to " + queryFileDir);
	...
	public void writeQueryTest(QueryTest tests) throws Exception {
		...
		try {
			...
			TestLogger.logInfo("Writing queries to file: " + f.getAbsolutePath());
		...
		TestLogger.logInfo("Completed writing queries ");
