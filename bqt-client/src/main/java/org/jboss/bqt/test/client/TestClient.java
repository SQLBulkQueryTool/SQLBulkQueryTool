...
import org.jboss.bqt.test.framework.connection.DataSourceConnection;
import org.jboss.bqt.test.framework.connection.DriverConnection;
...
public class TestClient {
	...
	private void runScenario() throws Exception {
		TestLogger.log("Starting scenario " + this.scenario_name);
	...
	protected void createSQL(QueryScenario queryset) throws Exception {
		TestLogger.logInfo("Start creating sql");
		...
		TestLogger.log("Completed create sql " );
